...
@allure.suite('Test User Sign Up')
class TestUserSignUp:
    @allure.title('test user sign up if all data correct')
    ...
    @allure.title('test user not sign in if user exist')
    ...
    @allure.title('test user not sign in if not all required fields_send')
